...
export function NowPlayingPage() {
  ...
  return (
    <div className="min-h-screen text-white overflow-y-auto bg-[radial-gradient(circle_at_10%_0%,rgba(125,157,255,0.35),transparent_40%),radial-gradient(circle_at_90%_0%,rgba(71,119,255,0.28),transparent_36%),linear-gradient(180deg,#070b18,#0d1734_55%,#090f22)]">
      <div className="mx-auto flex w-full max-w-7xl flex-col gap-8 px-4 pb-8 pt-4 lg:px-8">
        {/* Header */}
        <div className="flex items-center justify-between gap-3">
          ...
          <div className="text-center">
            ...
            <p className="hidden sm:block text-xs text-blue-100/55 mt-1">Desktop layout keeps the player, facts, and lyrics visible together</p>
          </div>
        ...
        <div className="grid grid-cols-1 gap-8 lg:grid-cols-[minmax(0,1.4fr)_minmax(320px,0.9fr)]">
          <main className="min-w-0 space-y-6">
            {/* Video Area */}
            <div className="w-full">
              <div className="mx-auto w-full max-w-[920px] aspect-video rounded-[28px] glass-surface relative overflow-hidden">
            ...
            <div className="space-y-4">
              <div>
                <h1 className="text-2xl sm:text-4xl font-bold mb-2 truncate">{currentVideo.title}</h1>
                <p className="text-blue-100/75 truncate text-sm sm:text-base">{currentVideo.channelTitle}</p>
              ...
              {/* Progress Bar */}
              <div className="glass-surface rounded-2xl px-4 py-4">
          ...
          <aside className="min-w-0 space-y-6 lg:sticky lg:top-28 self-start">
            {metadata && (
            ...
            <div className="glass-surface rounded-2xl p-4">
              <div className="flex items-center justify-between gap-3 mb-2">
                ...
                {metadataLoading && !metadata && (
                  <span className="text-xs text-blue-100/55">Loading track facts...</span>
                )}
              </div>
              {lyricsLoading ? (
                ...
                <>
                  <p className="text-blue-100/80 text-sm whitespace-pre-wrap leading-6 max-h-[32rem] overflow-auto pr-1">
                    {lyrics}
                  </p>
